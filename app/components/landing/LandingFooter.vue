    ...
    <div class="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8 py-10">
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div class="flex items-center gap-2.5">
          <img src="/logo.png" alt="Nestora" class="w-7 h-7" />
          <span class="font-bold text-lg text-foreground">Nestora</span>
          <Badge
            variant="secondary"
      ...
      <p class="text-center text-[11px] text-muted-foreground/50 leading-relaxed max-w-lg mx-auto">
        Returns may vary and are not guaranteed. Nestora is not a bank and does not provide financial advice.
      ...
      <p class="mt-4 text-center text-xs text-muted-foreground/60">
        &copy; {{ new Date().getFullYear() }} Nestora. Smart savings on Base.
      </p>
    </div>
  </footer>
</template>
